...
export default function UploadView({ layers, setLayers, setCollectedPoints, setSelectedLayerId, setActiveTab, projectCrs = 'EPSG:4326' }) {
  ...
  const handleFilePick = async (e) => {
    ...
    if (!main) {
      ...
      setStatus({ type: 'warn', msg: `Formato non importabile direttamente nel browser. Converti in GeoJSON/KML o aggiungi una libreria dedicata.` });
      return;
    }
    ...
    try {
      ...
      if (!prjCrs && !embedded) setStatus({ type: 'warn', msg: 'CRS non rilevato automaticamente. Conferma o modifica EPSG prima di importare.' });
    } catch (err) {
