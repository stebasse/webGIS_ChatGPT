...
const BottomNav = ({ activeTab, setActiveTab, onExport, selectedLayer, onAddFeature, language = 'it' }) => {
  const tabs = [
    { id: 'explore', label: t(language, 'explore'), icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
    { id: 'add-feature', label: t(language, 'geometry'), icon: 'M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0', isAction: true, special: true },
    { id: 'data-table', label: t(language, 'data'), icon: 'M4 6h16M4 12h16M4 18h16' },
