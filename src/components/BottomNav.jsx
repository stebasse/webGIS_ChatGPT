...
const BottomNav = ({ activeTab, setActiveTab, onExport, selectedLayer, onAddFeature }) => {
  const tabs = [
    ...
    { id: 'add-feature', label: 'Geometria', icon: 'M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0', isAction: true, special: true },
    { id: 'data-table', label: 'Dati', icon: 'M4 6h16M4 12h16M4 18h16' },
